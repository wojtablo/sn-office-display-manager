...
writeFileSync(docPath, cleanup(doc))
...
console.log(`generate-docs: docs/documentations.md, docs/tests.md, README.md written (${artifacts.length} Fluent artifacts).`)
...
function defaultReadme(name) {
    return [
        ...
        '```',
        '',
        'See [docs/documentations.md](./docs/documentations.md) and [docs/tests.md](./docs/tests.md) for the technical reference.',
        '',
        '## Authentication',
        '',
